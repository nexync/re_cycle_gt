...
class CycleModel():
    ...
    def t_cycle(text_batch): # optimizes g2t
        self.t2g_model.eval()
    ...
    def g_cycle(graph_batch): # optimizes t2g
        self.g2t_model.eval()
    ...
    def back_translation(self, text_batch, graph_batch):
        g_loss = g_cycle(graph_batch)
        t_loss = t_cycle(text_batch)
        ...
        for epoch in range(epochs):
            ...
            with tqdm.tqdm(dataloader) as tqb:
                for i, (text_batch, graph_batch) in enumerate(tqb):
                    ...
                    g_loss, t_loss = back_translation(text_batch, graph_batch)
